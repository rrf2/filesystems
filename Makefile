...
#
TEST = topen2 tcreate2 test1 writeread sync tcreate sample2 tlink topen sample1 tlink tsymlink tunlink2 tls fun_test bigfiletest tseek tsync fun_test2 thole
...
#
YFS_OBJS = yfs.o#example1.o example2.o
YFS_SRCS = yfs.c#example1.c example2.c
...
#
IOLIB_OBJS = iolib.o#example3.o example4.o
IOLIB_SRCS = iolib.c#example3.c example4.c
